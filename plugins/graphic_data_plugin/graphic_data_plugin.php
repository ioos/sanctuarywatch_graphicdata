...
function graphic_data_get_figure_block_meta( WP_REST_Request $request ) {
	...
	return rest_ensure_response(
		array(
			...
			'figure_iframe_code'               => get_post_meta( $post_id, 'figure_iframe_code', true ),
			...
			'figure_interactive_args_rendered' => get_post_meta( $post_id, 'figure_interactive_args_rendered', true ),
