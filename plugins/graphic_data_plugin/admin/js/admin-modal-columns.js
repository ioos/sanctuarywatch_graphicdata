...
function modal_instance_change() {
	const modal_instance_value =
		document.getElementById('modal_instance').value;
	const modal_scene = document.getElementById('modal_scene');
	modal_scene.innerHTML = null;
	const modal_scene_first_option = document.createElement('option');
...
document.addEventListener('DOMContentLoaded', function () {
	document
		.getElementById('modal_instance')
		.addEventListener('change', modal_instance_change);
});
