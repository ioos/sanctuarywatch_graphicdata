...
class Webcr {
	...
	//	$this->loader->add_filter( 'init', $plugin_admin, 'add_content_manager_custom_role'); 
		...
		$this->loader->add_action( 'settings_enqueue_scripts', $plugin_admin_settings_page, 'enqueue_admin_interactive_default_line_styles');
		$this->loader->add_action( 'settings_enqueue_scripts', $plugin_admin_settings_page, 'enqueue_admin_interactive_default_bar_styles');
