	...
	function create_instance_fields($return_fields_only = false)
	{
		...
		$fields = array(
			...
			array(
				...
				'type' => 'number',
				'title' => 'Latitude',
				'description' => 'Geographic latitude of the sanctuary (decimal degrees, -90 to 90). Example: 37.7749',
				'class' => 'text-class',
				'attributes' => array(
					'min' => '-90',
					'max' => '90',
			...
			array(
				...
				'type' => 'number',
				'title' => 'Longitude',
				'description' => 'Geographic longitude of the sanctuary (decimal degrees, -180 to 180). Example: -122.4194',
				'class' => 'text-class',
				'attributes' => array(
					'min' => '-180',
					'max' => '180',
		...
		$instance_rest_fields = array(
			...
			array('instance_latitude', 'number'),
			array('instance_longitude', 'number')
		);
