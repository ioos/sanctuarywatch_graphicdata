...
class Graphic_Data_Plugin {
	...
	public function define_admin_hooks() {
		...
		$this->loader->add_action( 'manage_page_posts_columns', $plugin_page_options, 'change_page_columns' );
		$this->loader->add_action( 'manage_page_posts_custom_column', $plugin_page_options, 'custom_page_column', 10, 2 );
		$this->loader->add_action( 'admin_notices', $plugin_page_options, 'overview_scene_editor_notice' );
		$this->loader->add_action( 'enqueue_block_editor_assets', $plugin_page_options, 'enqueue_overview_scene_notice' );
		...
		$this->loader->add_action( 'restrict_manage_posts', $plugin_media_manager, 'render_instance_filter_dropdown' );
		$this->loader->add_action( 'parse_query', $plugin_media_manager, 'filter_media_by_instance' );
		$this->loader->add_filter( 'ajax_query_attachments_args', $plugin_media_manager, 'filter_ajax_media_by_instance' );
		$this->loader->add_action( 'admin_enqueue_scripts', $plugin_media_manager, 'enqueue_instance_filter_script' );
