		...
		$graphic_data_cpt_config = array(
			...
			'modal'  => array(
				...
				'link_cb'  => static function ( $post_id ) {
					...
					// $modal_instance_slug = get_post_field( 'post_name', $modal_instance ); Old version that registers the instance, not instance slug.
					$modal_instance_slug = get_post_meta( $modal_instance, 'instance_slug', true );
			...
			'figure' => array(
				...
				'link_cb'  => static function ( $post_id ) {
					...
					// $figure_instance_slug = get_post_field( 'post_name', $figure_instance ); Old version that registers the instance, not instance slug.
					$figure_instance_slug = get_post_meta( $figure_instance, 'instance_slug', true );
