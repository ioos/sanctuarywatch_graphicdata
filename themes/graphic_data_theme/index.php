...
<div id="above_entire_thing">
	...
	echo "<div class='container-fluid-index main-container' style='margin-top: 0px;'><h4 style='color:#033c73;'>" . wp_kses_post( wpautop( $graphic_data_front_page_intro ) ) . '</h4></div>';
	?>
</div> 
